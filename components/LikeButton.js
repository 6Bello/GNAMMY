    ...
    const handleLike = () => {
      ...
      console.log("idRecipe: ", idRecipe);
          if (userFavouriteRecipes.includes(idRecipe)) {
            ...
            axios.post(`http://gnammy.mywire.org:443/removeFavouriteRecipe/${idUser}`, {idRecipe}) // Effettua una richiesta POST all'endpoint specificato utilizzando Axios
            .then(res => {
              console.log('rimosso!');
            ...
            setIsLiked(true);
            console.log("itemId: ", idRecipe)
            axios.post(`http://gnammy.mywire.org:443/addFavouriteRecipe/${idUser}`, {idRecipe}) // Effettua una richiesta POST all'endpoint specificato utilizzando Axios
            .then(res => {
